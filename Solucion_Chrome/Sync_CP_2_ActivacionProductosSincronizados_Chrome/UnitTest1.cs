...
namespace Sync_CP_2_ActivacionProductosSincronizados_Chrome
{
    [TestClass]
    public class CP2ActivacionProductosSincronizadosChrome
    {
        ...
        [TestMethod]
        public void TheCP2ActivacionProductosSincronizadosChromeTest()
        {
            try
            {
                ...
                Thread.Sleep(15000);
               // driver.FindElement(By.ClassName("panel-body")).SendKeys(Keys.Down);

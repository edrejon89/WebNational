...
{
    [TestClass]
    public class EdicionDeImpuestosChrome
    {
        ...
        [TestMethod]
        public void TheEdicionDeImpuestosChromeTest()
        {
            try
            {
                ...
                Thread.Sleep(1000);
                driver.FindElement(By.CssSelector("button[class = 'btn btn-success btn-labeled fa fa-save']")).Click();
                Thread.Sleep(3000);

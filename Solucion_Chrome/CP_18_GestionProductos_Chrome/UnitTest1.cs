...
namespace SeleniumTests
{
    ...
    public class CP18GestionProductosChromeTest
    {
        ...
        public void TheCP18GestionProductosChromeTest()
        {
            try
            {
                string[] parametros = LeerCSV("C:\\Users\\ADMDBQA.user\\Documents\\CP18_Configuracion.csv.txt");
                ...
                Thread.Sleep(1000);
                new SelectElement(driver.FindElement(By.Id("cbxTypeAmountPercent"))).SelectByText(parametros[2]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("cbxTypeAmountPercent")).Click();
                Thread.Sleep(1000);
                driver.FindElement(By.Id("cbxTypeWithNoneImp")).Click();
                Thread.Sleep(1000);
                new SelectElement(driver.FindElement(By.Id("cbxTypeWithNoneImp"))).SelectByText(parametros[3]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("cbxTypeWithNoneImp")).Click();
                Thread.Sleep(1000);
                driver.FindElement(By.Id("incrementAmount")).Click();
                driver.FindElement(By.Id("incrementAmount")).Clear();
                driver.FindElement(By.Id("incrementAmount")).SendKeys(parametros[4]);
                Thread.Sleep(1000);
                driver.FindElement(By.CssSelector("#productContent > tr > td:nth-child(5) > div > span")).Click();
                Thread.Sleep(2000);
                driver.FindElement(By.CssSelector("#btnSaveValueChanges > span.hidden-md")).Click();
                Thread.Sleep(1000);

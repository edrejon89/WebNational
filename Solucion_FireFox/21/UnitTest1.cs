...
namespace SeleniumTests
{
    ...
    public class EditarCampana
    {
        ...
        [TestMethod]
        public void EditarCampanaTest()
        {
            try
            {
                string[] parametros = LeerCSV("C:\\Users\\ADMDBQA.user\\Documents\\CP21_Configuracion.txt");
                ...
                driver.FindElement(By.CssSelector("a[href = '/Promotion']")).Click();
                Thread.Sleep(2000);
                IReadOnlyCollection<IWebElement> promociones = driver.FindElements(By.CssSelector("button[class='btn btn-sm btn-primary']"));
                Thread.Sleep(2000);
                promociones.ElementAt(Int32.Parse(parametros[2])).Click();
                Thread.Sleep(5000);
                driver.FindElement(By.Id("btnAddCoupon")).SendKeys(Keys.PageDown);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("btnAddCoupon")).Click();
                Thread.Sleep(5000);
                driver.FindElement(By.CssSelector("[href='#wizard-general-tab']")).SendKeys(Keys.PageUp);
                //driver.FindElement(By.Id("Coupon_Name")).SendKeys(Keys.PageUp);
                Thread.Sleep(2000);
                driver.FindElement(By.Id("Coupon_Name")).Click();
                driver.FindElement(By.Id("Coupon_Name")).Clear();
                driver.FindElement(By.Id("Coupon_Name")).SendKeys(parametros[3]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_Description")).Clear();
                driver.FindElement(By.Id("Coupon_Description")).SendKeys(parametros[4]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_Code")).Clear();
                driver.FindElement(By.Id("Coupon_Code")).SendKeys(parametros[5]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_Budget")).Click();
                driver.FindElement(By.Id("Coupon_Budget")).Clear();
                driver.FindElement(By.Id("Coupon_Budget")).SendKeys(parametros[6]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_Amount")).Click();
                driver.FindElement(By.Id("Coupon_Amount")).Clear();
                driver.FindElement(By.Id("Coupon_Amount")).SendKeys(parametros[7]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_Quantity")).Click();
                driver.FindElement(By.Id("Coupon_Quantity")).Clear();
                driver.FindElement(By.Id("Coupon_Quantity")).SendKeys(parametros[8]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_MaximumCouponRedemption")).Clear();
                driver.FindElement(By.Id("Coupon_MaximumCouponRedemption")).SendKeys(parametros[9]);
                ...
                driver.FindElement(By.Id("Coupon_MinimumPurchase")).SendKeys(parametros[10]);
                Thread.Sleep(1000);
                driver.FindElement(By.Id("Coupon_MaximumDiscount")).Click();
                driver.FindElement(By.Id("Coupon_MaximumDiscount")).Clear();
                driver.FindElement(By.Id("Coupon_MaximumDiscount")).SendKeys(parametros[11]);
                Thread.Sleep(1000);
                ...
                Thread.Sleep(3000);
                driver.FindElement(By.Id("Coupon_EndDate")).SendKeys(Keys.PageUp);
                Thread.Sleep(500);
                ...
                Thread.Sleep(1000);
                driver.FindElement(By.CssSelector("a[href = '/RestaurantWizard']")).SendKeys(Keys.PageUp); //debe quitarse
                Thread.Sleep(1000);
                driver.FindElement(By.CssSelector("a[href = '/RestaurantWizard']")).Click();
                Thread.Sleep(500);
